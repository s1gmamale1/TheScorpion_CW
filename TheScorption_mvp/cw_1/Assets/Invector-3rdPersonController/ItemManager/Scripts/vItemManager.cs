...
namespace Invector.vItemManager
{
    ...
    public partial class vItemManager : vMonoBehaviour, IActionReceiver
    {
        ...
        /// <summary>
        /// Event called to collect item ref
        /// </summary>
        public OnCollectItemRefEvent onCollectItemRef;
        /// <summary>
        ...
        {
            var item = items.Find(i => i.id == itemRef.id);
            if (item != null && item.stackable == false && item.createNewItem == false)
            {
                onCollectItemRef?.Invoke(itemRef);
                return;
            }
