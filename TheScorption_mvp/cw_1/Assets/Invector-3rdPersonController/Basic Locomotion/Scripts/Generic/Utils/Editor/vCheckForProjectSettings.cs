    ...
    public class vCheckForProjectSettings
    {
        ...
        public static void CheckLayer()
        {
            ...
            if (validation && !isClosed)
            {
                ...
                rect.width = 600;
                rect.height = 200;
                rect.x += 50; // add 40 units to the right
                string myString = "Step 1: Open Edit > ProjectSettings > Player > Set ActiveInputHandling to \"Both\" \n\n Step 2: Open Invector > Import ProjectSettings";
